...
By default, `bun dev` runs OpenCode in the `packages/boros` directory. To run it against a different directory or repository:
...
```bash
./packages/boros/dist/opencode-<platform>/bin/opencode
```

Replace `<platform>` with your platform (e.g., `darwin-arm64`, `linux-x64`).

- Core pieces:
  - `packages/boros`: OpenCode core business logic & server.
