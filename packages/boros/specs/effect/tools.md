...
Practical reference for the current tool-migration state in `packages/boros`.
...
Tool tests should use the existing Effect helpers in `packages/boros/test/lib/effect.ts`:
