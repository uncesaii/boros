...
import { makeApi } from "@boros-ai/protocol/api"
import { LocationMiddleware } from "@boros-ai/server/location"
import { SessionLocationMiddleware } from "@boros-ai/server/middleware/session-location"
...
export const BorosHttpApi = HttpApi.make("opencode")
