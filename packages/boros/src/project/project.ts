...
import { ProjectDirectoryTable, ProjectTable } from "@boros-ai/core/project/sql"
import { ProjectDirectories } from "@boros-ai/core/project/directories"
...
import { which } from "@boros-ai/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@boros/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.BOROS_FAKE_VCS)
