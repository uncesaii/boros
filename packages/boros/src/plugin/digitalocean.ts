import type { Hooks, PluginInput } from "@boros-ai/plugin"
import type { Model } from "@boros-ai/sdk/v2"
import { InstallationVersion } from "@boros-ai/core/installation/version"
import { OauthCallbackPage } from "@boros-ai/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. Boros will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
