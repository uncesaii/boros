...
} from "@boros-ai/plugin"
import { Config } from "@/config/config"
import { createOpencodeClient } from "@boros-ai/sdk"
...
export class Service extends Context.Service<Service, Interface>()("@boros/Plugin") {}

// Boros ships no built-in auth plugins: the provider surface is local Ollama,
// Ollama Cloud, and custom OpenAI-compatible endpoints, none of which require an
// OAuth device-flow plugin. External plugins can still be added via config.
