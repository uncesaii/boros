...
import type * as SDK from "@boros-ai/sdk/v2"
...
import { SessionShareTable } from "@boros-ai/core/share/sql"
...
const disabled = process.env["BOROS_DISABLE_SHARE"] === "true" || process.env["BOROS_DISABLE_SHARE"] === "1" || process.env["OPENCODE_DISABLE_SHARE"] === "true" || process.env["OPENCODE_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@boros/ShareNext") {}
