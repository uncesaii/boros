 ...
 *   "@boros/ServerAuthConfig",
 *   {
 *     password: Config.string("BOROS_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("BOROS_SERVER_USERNAME").pipe(Config.withDefault("boros")),
 *   },
 * ) {}
 *
