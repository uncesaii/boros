...
import { buildPrompt } from "@boros-ai/core/session/compaction"
import { SessionCompactionEvent } from "@boros-ai/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@boros/SessionCompaction") {}
