...
import { locationServiceMapLayer } from "@boros-ai/core/location-services"
...
import { PartTable, SessionTable } from "@boros-ai/core/session/sql"
...
import { WorkspaceV2 } from "@boros-ai/core/workspace"
import { SessionID, MessageID, PartID } from "./schema"

import type { Provider } from "@/provider/provider"
import { Global } from "@boros-ai/core/global"
import { Effect, Layer, Option, Context, Schema, Types } from "effect"
import { NonNegativeInt, optional } from "@boros-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".boros", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@boros/Session") {}
