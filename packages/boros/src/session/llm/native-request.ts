import type { JsonSchema, LLMRequest, ProviderMetadata } from "@boros-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@boros-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @boros-ai/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
