...
import { MAX_STEPS_PROMPT } from "@boros-ai/core/session/runner/max-steps"
...
import { LLM } from "./llm"
import { Shell } from "@boros-ai/core/shell"
...
import { LLMEvent } from "@boros-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@boros/SessionPrompt") {}
