import type { NamedError } from "@boros-ai/core/util/error"
...
export const GO_UPSELL_MESSAGE = "Usage limit reached; retrying with backoff."
export const GO_UPSELL_URL = "https://github.com/uncesaii/boros"
export type RetryReason = "rate_limit" | (string & {})
    ...
    if (error.data.responseBody?.includes("FreeUsageLimitError")) {
      return {
        ...
        action: {
          ...
          provider,
          title: "Usage limit",
          message: "Rate limit reached. Boros will retry with backoff, or choose another provider/model.",
          label: "retry",
        },
      }
    }
