...
import { EventSequenceTable, EventTable } from "@boros-ai/core/event/sql"
...
import { WorkspaceEvent } from "@boros-ai/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@boros/Workspace") {}
