...
import { normalizePromptContent } from "@boros-ai/tui/editor"
...
import { BOROS_BASE_MODE, useBindings } from "@boros-ai/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close Boros" } satisfies SlashOption,
    ]
