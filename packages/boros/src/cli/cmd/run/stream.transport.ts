...
import type { Event, GlobalEvent, OpencodeClient } from "@boros-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@boros/RunStreamTransport") {}
