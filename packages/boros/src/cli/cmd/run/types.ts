// Shared type vocabulary for the direct interactive mode (`boros --mini`).
//
...
import type { OpencodeClient, PermissionRequest, QuestionRequest, ToolPart } from "@boros-ai/sdk/v2"
