...
export class Service extends Context.Service<Service, Interface>()("@boros/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __BOROS_PHOTON_WASM_PATH?: string }).__BOROS_PHOTON_WASM_PATH =
