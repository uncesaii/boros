...
import { IdeEvent } from "@boros-ai/schema/ide-event"
...
export function alreadyInstalled() {
  return process.env["BOROS_CALLER"] === "vscode" || process.env["BOROS_CALLER"] === "vscode-insiders" || process.env["OPENCODE_CALLER"] === "vscode" || process.env["OPENCODE_CALLER"] === "vscode-insiders"
}
