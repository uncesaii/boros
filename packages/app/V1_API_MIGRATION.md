...
The app is currently hybrid. In this document, V1 refers to the legacy unprefixed server APIs used by `@boros-ai/sdk/v2`, despite the SDK package name.
...
- [ ] Remove the `@boros-ai/sdk` runtime dependency after all legacy calls and types are gone.
  - `package.json`
