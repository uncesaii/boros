...
import type { Config, OpencodeClient, Project } from "@boros-ai/sdk/v2/client"
import type { AgentApi, CatalogApi, CommandApi, ReferenceApi } from "@boros-ai/client/promise"
