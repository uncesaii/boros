import { useFilteredList } from "@boros-ai/ui/hooks"
import { useSpring } from "@boros-ai/ui/motion-spring"
import {
  createEffect,
  on,
  Component,
...
import { DockShellForm, DockTray } from "@boros-ai/ui/dock-surface"
import { Icon } from "@boros-ai/ui/icon"
import { ProviderIcon } from "@boros-ai/ui/provider-icon"
import { Tooltip, TooltipKeybind } from "@boros-ai/ui/tooltip"
...
import { KeybindV2 } from "@boros-ai/ui/v2/keybind-v2"
...
import type { ReferenceInfo } from "@boros-ai/sdk/v2/client"
...
export const PromptInput: Component<PromptInputProps> = (props) => {
  ...
  const placeholder = createMemo(() =>
    promptPlaceholder({
      ...
      example: suggest() ? (store.mode === "shell" ? "nmap -sV example.com" : language.t(EXAMPLES[store.placeholder])) : "",
      suggest: suggest(),
