...
beforeAll(async () => {
  ...
  mock.module("@boros-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@boros-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@boros-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@boros-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
