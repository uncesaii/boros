...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    items: [
      { type: "item", labelKey: "desktop.menu.documentation", href: "https://github.com/uncesaii/boros" },
      { type: "item", labelKey: "desktop.menu.supportForum", href: "https://github.com/uncesaii/boros/issues" },
      { type: "item", labelKey: "desktop.menu.exportLogs", command: "logs.export" },
      { type: "separator" },
      {
        type: "item",
        labelKey: "desktop.menu.shareFeedback",
        href: "https://github.com/uncesaii/boros/issues/new",
      },
      {
        type: "item",
