...
export const TypeId: TypeId = "~@boros-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@boros-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@boros-ai/effect-sqlite-node/NodeSqliteClient")
