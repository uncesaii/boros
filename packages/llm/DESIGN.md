...
> current private `@boros-ai/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@boros-ai/ai`
...
import { LLM } from "@boros-ai/ai"
import { OpenAI } from "@boros-ai/ai/providers/openai"
...
```ts
import { Message } from "@boros-ai/ai"
...
import { LLM, Tool } from "@boros-ai/ai"
...
```ts
import { LLM } from "@boros-ai/ai/promise"
import { OpenAI } from "@boros-ai/ai/providers/openai"
...
```ts
import { LLMSchema } from "@boros-ai/ai/schema"
...
```ts
import { Provider, Protocol } from "@boros-ai/ai/provider"
...
@boros-ai/ai/provider
  experimental Provider and Protocol authoring APIs

@boros-ai/ai/providers/openai
@boros-ai/ai/providers/anthropic
@boros-ai/ai/providers/google
...
```
