...
import { compile, emitEffectImported, emitPromise, write } from "@boros-ai/httpapi-codegen"
        ...
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              ...
              import: 'import type { OpenCodeEventEncoded } from "@boros-ai/protocol/groups/event"',
            },
          },
        }),
