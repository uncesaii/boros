...
import type { AssistantMessage, FilePart, UserMessage } from "@boros-ai/sdk/v2"
...
import { BOROS_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useBorosKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.BOROS_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
