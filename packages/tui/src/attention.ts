...
import defaultSoundPath from "@boros-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@boros-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@boros-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@boros-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@boros-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@boros-ai/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "boros"
const DEFAULT_PACK_ID = "boros.default"
