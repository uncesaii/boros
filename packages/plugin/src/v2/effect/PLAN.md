...
- Effect plugins import `@boros-ai/plugin/v2/effect`, not `@boros-ai/core`.
- Public domain values use generated `@boros-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@boros-ai/plugin/v2/effect`.
