...
class Database extends Context.Service<Database, DatabaseShape>()("@boros/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@boros/example/UserStore") {
