...
import { Message, Model } from "@boros-ai/llm"
...
import { AgentAttachment, FileAttachment } from "@boros-ai/core/session/prompt"
import { toLLMMessages } from "@boros-ai/core/session/runner/to-llm-message"
    ...
    const messages = toLLMMessages(
      [
        ...
        SessionMessage.User.make({
          ...
          files: [file],
          agents: [AgentAttachment.make({ name: "operator" })],
          time: { created },
        }),
