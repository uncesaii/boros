...
import type { Data, Definition, Payload } from "@boros-ai/schema/event"
...
import { Durable } from "@boros-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@boros-ai/schema/event").ID
export type { Data, Definition, Payload } from "@boros-ai/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@boros/Event") {}
