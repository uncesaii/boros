...
import { ListAnchor } from "@boros-ai/schema/session"
...
import { SessionDurable } from "@boros-ai/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@boros/v2/Session") {}
