...
import type { IntegrationOAuthMethodRegistration } from "@boros-ai/plugin/v2/effect/integration"
import { define } from "@boros-ai/plugin/v2/effect/plugin"
...
function headers(contentType: string) {
  return { "Content-Type": contentType, "User-Agent": `boros/${InstallationVersion}` }
}
