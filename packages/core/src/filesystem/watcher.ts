...
import { FileSystemWatcher } from "@boros-ai/schema/filesystem-watcher"
...
declare const BOROS_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof BOROS_LIBC === "undefined" ? undefined : BOROS_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@boros/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.BOROS_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.BOROS_EXPERIMENTAL_FILEWATCHER)) {
