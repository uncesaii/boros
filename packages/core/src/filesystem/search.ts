...
export class Service extends Context.Service<Service, Interface>()("@boros/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.BOROS_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
