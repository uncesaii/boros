...
import { Event } from "@boros-ai/schema/project-directories"
import { ProjectCopy } from "@boros-ai/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@boros/ProjectCopy") {}
