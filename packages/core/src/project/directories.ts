...
import type { EffectDrizzleSqlite } from "@boros-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@boros/ProjectDirectories") {}
