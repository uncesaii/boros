...
export const Info = Schema.Struct({
  ...
  command: Schema.optional(Schema.Record(Schema.String, ConfigCommandV1.Info)).annotate({
    description: "Command configuration, see https://raw.githubusercontent.com/uncesaii/boros/main/commands",
  }),
  ...
  ).annotate({ description: "Agent configuration, see https://raw.githubusercontent.com/uncesaii/boros/main/agents" }),
