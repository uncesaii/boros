...
import { Entry, FileSystem, FindInput, Match } from "@boros-ai/schema/filesystem"
export { Entry, Match, Submatch } from "@boros-ai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@boros/v2/FileSystem") {}
